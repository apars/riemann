...
$db['local']['username'] = 'nisbeta1_etrans'; // change to your MySQL username
$db['local']['password'] = 'Numerico_2013'; // change to your MySQL user's password
...
$db['dev']['username'] = 'nisbeta1_etrans'; // change to your MySQL username
$db['dev']['password'] = 'Numerico_2013'; // change to your MySQL user's password

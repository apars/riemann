...
<!--    <audio autoplay>
    ...
    <div>
        <h2 class="introtext" style="text-align: center; font-family: AmaticSC; font-size: 6vh;margin-top: auto;margin-bottom: auto;">Register your cellphone number for a chance to win <u>AMAZING PRIZES</u>!<br><br>
        </h2>
        <div class="col-md-5 form-group" style="margin-left: auto; margin-right: auto;">
            <label for="text-basic">Touch text box below to input cellphone number.<br></label>
            <input type="number" class="form-control" id="text-basic" style="max-height: 100%;max-width: 100%" placeholder="Enter cellphone number...">
	</div>
